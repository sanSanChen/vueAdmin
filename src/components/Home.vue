	...
	<el-row class="container">
		...
		<el-col :span="24" class="main">
			<aside :class="collapsed?'menu-collapsed':'menu-expanded'">
				<!--导航菜单-->
				<el-menu ref="el-menu" :default-active="$route.path" class="el-menu-vertical-demo" @open="handleopen" @close="handleclose" @select="handleselect"
	...
	export default {
		...
		methods: {
			...
			collapse:function(){
				...
				//侧边栏折叠后打开宽度有问题，手动设置。
				this.$refs['el-menu'].$el.style.width="100%";
			},
			showMenu(i,status){
